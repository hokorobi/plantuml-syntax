...
syntax keyword plantumlSkinparamKeyword ArrowLollipopColor ArrowThickness ArtifactBackgroundColor ArtifactBorderColor
...
syntax keyword plantumlSkinparamKeyword BoundaryStereotypeFontSize BoundaryStereotypeFontStyle CaptionFontColor
syntax keyword plantumlSkinparamKeyword CaptionFontName CaptionFontSize CaptionFontStyle CardBackgroundColor
syntax keyword plantumlSkinparamKeyword CardBorderColor CardBorderThickness CardFontColor CardFontName CardFontSize
syntax keyword plantumlSkinparamKeyword CardFontStyle CardStereotypeFontColor CardStereotypeFontName
syntax keyword plantumlSkinparamKeyword CardStereotypeFontSize CardStereotypeFontStyle CircledCharacterFontColor
syntax keyword plantumlSkinparamKeyword CircledCharacterFontName CircledCharacterFontSize CircledCharacterFontStyle
syntax keyword plantumlSkinparamKeyword CircledCharacterRadius ClassAttributeFontColor ClassAttributeFontName
syntax keyword plantumlSkinparamKeyword ClassAttributeFontSize ClassAttributeFontStyle ClassAttributeIconSize
syntax keyword plantumlSkinparamKeyword ClassBackgroundColor ClassBorderColor ClassBorderThickness ClassFontColor
syntax keyword plantumlSkinparamKeyword ClassFontName ClassFontSize ClassFontStyle ClassHeaderBackgroundColor
syntax keyword plantumlSkinparamKeyword ClassStereotypeFontColor ClassStereotypeFontName ClassStereotypeFontSize
syntax keyword plantumlSkinparamKeyword ClassStereotypeFontStyle CloudBackgroundColor CloudBorderColor CloudFontColor
syntax keyword plantumlSkinparamKeyword CloudFontName CloudFontSize CloudFontStyle CloudStereotypeFontColor
syntax keyword plantumlSkinparamKeyword CloudStereotypeFontName CloudStereotypeFontSize CloudStereotypeFontStyle
syntax keyword plantumlSkinparamKeyword CollectionsBackgroundColor CollectionsBorderColor ColorArrowSeparationSpace
syntax keyword plantumlSkinparamKeyword ComponentBackgroundColor ComponentBorderColor ComponentBorderThickness
...
syntax keyword plantumlSkinparamKeyword NoteFontStyle NoteShadowing ObjectAttributeFontColor ObjectAttributeFontName
syntax keyword plantumlSkinparamKeyword ObjectAttributeFontSize ObjectAttributeFontStyle ObjectBackgroundColor
syntax keyword plantumlSkinparamKeyword ObjectBorderColor ObjectBorderThickness ObjectFontColor ObjectFontName
syntax keyword plantumlSkinparamKeyword ObjectFontSize ObjectFontStyle ObjectStereotypeFontColor
...
syntax keyword plantumlSkinparamKeyword PackageStereotypeFontStyle PackageStyle Padding PageBorderColor
syntax keyword plantumlSkinparamKeyword PageExternalColor PageMargin ParticipantBackgroundColor ParticipantBorderColor
syntax keyword plantumlSkinparamKeyword ParticipantFontColor ParticipantFontName ParticipantFontSize
syntax keyword plantumlSkinparamKeyword ParticipantFontStyle PartitionBackgroundColor PartitionBorderColor
...
syntax keyword plantumlSkinparamKeyword SwimlaneTitleFontStyle SwimlaneWidth TabSize TitleBackgroundColor
syntax keyword plantumlSkinparamKeyword TitleBorderColor TitleBorderRoundCorner TitleBorderThickness TitleFontColor
syntax keyword plantumlSkinparamKeyword TitleFontName TitleFontSize TitleFontStyle UsecaseBackgroundColor
syntax keyword plantumlSkinparamKeyword UsecaseBorderColor UsecaseBorderThickness UsecaseFontColor UsecaseFontName
