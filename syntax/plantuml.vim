...
syntax region plantumlActivityNote matchgroup=plantumlKeyword start=/^\s*[rh]\?note\s[^:]\+:/ end=/$/
syntax region plantumlActivityNote matchgroup=plantumlKeyword start=/^\s*[rh]\?note\s[^:]\+$/ end=/^\s*end note$/
