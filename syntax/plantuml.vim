...
syntax keyword plantumlSkinparamKeyword CaptionFontStyle CardBackgroundColor CardBorderColor CardBorderThickness
syntax keyword plantumlSkinparamKeyword CardFontColor CardFontName CardFontSize CardFontStyle CardStereotypeFontColor
...
syntax keyword plantumlSkinparamKeyword FrameStereotypeFontSize FrameStereotypeFontStyle GenericDisplay Guillemet
syntax keyword plantumlSkinparamKeyword Handwritten HeaderFontColor HeaderFontName HeaderFontSize HeaderFontStyle
...
syntax keyword plantumlSkinparamKeyword IconPublicBackgroundColor IconPublicColor InterfaceBackgroundColor
syntax keyword plantumlSkinparamKeyword InterfaceBorderColor InterfaceFontColor InterfaceFontName InterfaceFontSize
syntax keyword plantumlSkinparamKeyword InterfaceFontStyle InterfaceStereotypeFontColor InterfaceStereotypeFontName
...
syntax keyword plantumlSkinparamKeyword ResponseMessageBelowArrow RoundCorner SameClassWidth
syntax keyword plantumlSkinparamKeyword SequenceActorBorderThickness SequenceArrowThickness SequenceBoxBackgroundColor
...
syntax keyword plantumlSkinparamKeyword SequenceDividerBackgroundColor SequenceDividerBorderColor
